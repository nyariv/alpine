  ...
  */
  ...
  function () {
    ...
    _createClass(SimpleObservableMembrane, [{
      ...
      key: "defaultValueMutated",
      value: function defaultValueMutated(target, key) {}
    }, {
      key: "getProxy",
      value: function getProxy(value) {
        ...
        if (this.valueIsObservable(value)) {
          var proxy = this.proxies.get(value);

          if (proxy) {
            return proxy;
          }

          var reactiveHandler = this.proxyHandler(this, value);
      ...
      key: "unwrapProxy",
      value: function unwrapProxy(value) {
